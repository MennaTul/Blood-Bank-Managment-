...
static constexpr auto qt_meta_stringdata_CLASSFirstPageENDCLASS = QtMocHelpers::stringData(
    "FirstPage"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSFirstPageENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSFirstPageENDCLASS_t qt_meta_stringdata_CLASSFirstPageENDCLASS = {
    {
