/********************************************************************************
** Form generated from reading UI file 'RecipientLogIn.ui'
**
...
#ifndef UI_RECIPIENTLOGIN_H
#define UI_RECIPIENTLOGIN_H
...
public:
    ...
    void setupUi(QMainWindow *RecipientLogInClass)
    {
        if (RecipientLogInClass->objectName().isEmpty())
            RecipientLogInClass->setObjectName("RecipientLogInClass");
        RecipientLogInClass->resize(758, 612);
        QIcon icon;
        ...
        RecipientLogInClass->setWindowIcon(icon);
        RecipientLogInClass->setStyleSheet(QString::fromUtf8(""));
        centralWidget = new QWidget(RecipientLogInClass);
...
"font: 700 10pt \"Arial\";"));
        ...
        label->setGeometry(QRect(80, 130, 141, 21));
...
"font: 700 9pt \"Segoe UI\";"));
        ...
        back->setGeometry(QRect(10, 503, 21, 31));
        ...
        label_2->setGeometry(QRect(10, 540, 51, 16));
        QFont font3;
        font3.setPointSize(6);
        label_2->setFont(font3);
        label_2->setStyleSheet(QString::fromUtf8("color:rgb(117, 117, 117)"));
        RecipientLogInClass->setCentralWidget(centralWidget);
        menuBar = new QMenuBar(RecipientLogInClass);
        menuBar->setObjectName("menuBar");
        menuBar->setGeometry(QRect(0, 0, 758, 22));
        RecipientLogInClass->setMenuBar(menuBar);
        mainToolBar = new QToolBar(RecipientLogInClass);
        mainToolBar->setObjectName("mainToolBar");
        RecipientLogInClass->addToolBar(Qt::TopToolBarArea, mainToolBar);
        statusBar = new QStatusBar(RecipientLogInClass);
        statusBar->setObjectName("statusBar");
        RecipientLogInClass->setStatusBar(statusBar);

        retranslateUi(RecipientLogInClass);

        pushButton->setDefault(false);


        QMetaObject::connectSlotsByName(RecipientLogInClass);
    } // setupUi

    void retranslateUi(QMainWindow *RecipientLogInClass)
    {
        RecipientLogInClass->setWindowTitle(QCoreApplication::translate("RecipientLogInClass", "Blood Bank Management System", nullptr));
        backimg->setText(QString());
        label_3->setText(QCoreApplication::translate("RecipientLogInClass", "Mail", nullptr));
        label_5->setText(QCoreApplication::translate("RecipientLogInClass", "Password", nullptr));
        mailalertmsg->setText(QCoreApplication::translate("RecipientLogInClass", "please provide a valid value", nullptr));
        passwordalertmsg->setText(QCoreApplication::translate("RecipientLogInClass", "please provide a valid value", nullptr));
        label_12->setText(QString());
        wrong->setText(QCoreApplication::translate("RecipientLogInClass", "Wrong mail or password", nullptr));
#if QT_CONFIG(tooltip)
        pushButton->setToolTip(QCoreApplication::translate("RecipientLogInClass", "<html><head/><body><p align=\"center\"><br/></p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        pushButton->setText(QCoreApplication::translate("RecipientLogInClass", "Log In", nullptr));
        label->setText(QCoreApplication::translate("RecipientLogInClass", "  Recipient Log In", nullptr));
        label_13->setText(QCoreApplication::translate("RecipientLogInClass", "Don't have an account?", nullptr));
        pushButton_2->setText(QCoreApplication::translate("RecipientLogInClass", "Register", nullptr));
        back->setText(QString());
        label_2->setText(QCoreApplication::translate("RecipientLogInClass", "Previous Page", nullptr));
    } // retranslateUi

};

namespace Ui {
    class RecipientLogInClass: public Ui_RecipientLogInClass {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_RECIPIENTLOGIN_H
